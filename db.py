...
DEFAULTS = {
    ...
    "TELNYX_SIP_DOMAIN":           os.getenv("TELNYX_SIP_DOMAIN", "sip.telnyx.com"),
    "TELNYX_USERNAME":             os.getenv("TELNYX_USERNAME", ""),
    "TELNYX_PASSWORD":             os.getenv("TELNYX_PASSWORD", ""),
    "TELNYX_OUTBOUND_NUMBER":      os.getenv("TELNYX_OUTBOUND_NUMBER", ""),
    "TELNYX_DID_2":                os.getenv("TELNYX_DID_2", ""),
    "TELNYX_DID_3":                os.getenv("TELNYX_DID_3", ""),
    "TELNYX_DID_4":                os.getenv("TELNYX_DID_4", ""),
    "ACTIVE_TELEPHONY_PROVIDER":   os.getenv("ACTIVE_TELEPHONY_PROVIDER", "vobiz"),
